        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 min-h-[85vh] p-6 lg:p-8">
            ...
            <div class="flex justify-between items-center mb-8 rounded-3xl">
                ...
                <a href="{{ route('admin.packages.create') }}"
                    class="px-2.5 py-2.5 bg-gray-700 hover:bg-red-700 text-white rounded-full transition shadow-sm">
            ...
            @if (session('success'))
                <div
                    class="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 mb-4 rounded-r-lg flex items-center gap-2">
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="p-4 font-bold text-gray-800">
                                        ...
                                        <div class="text-xs font-normal text-gray-400 mt-0.5 truncate max-w-[200px]">
                                            {{ Str::limit($package->tagline, 40) }}
                                        </div>
                                    </td>

                                    {{-- HARGA & KAPASITAS (Diperbarui) --}}
                                    <td class="p-4">
                                        <div class="font-bold text-red-600 mb-1">
                                        ...
                                        <div class="text-xs text-gray-500 flex items-center gap-1">
                                            ...
                                            Max: {{ $package->max_pax }} Orang
                                        </div>
                                        @if ($package->extra_price_per_pax > 0)
                                            <div class="text-[10px] text-gray-400 mt-0.5">
                                                (Tambahan Rp
                                                {{ number_format($package->extra_price_per_pax, 0, ',', '.') }}/orang)
                                            </div>
                                        @endif
                                    </td>
