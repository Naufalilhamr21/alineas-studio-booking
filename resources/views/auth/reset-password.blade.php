...
<head>
    ...
    <title>Reset Password - Alineas Studio</title>
    ...
    <div class="min-h-screen flex flex-col justify-center items-center px-6 py-12 lg:px-8">
        ...
        <div class="w-full max-w-sm md:max-w-md bg-white shadow-xl p-8 md:p-10 rounded-3xl border border-gray-100">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-extrabold text-gray-900 tracking-tighter uppercase">
                    RESET PASSWORD
                </h1>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" :type="showPassword ? 'text' : 'password'" name="password" required
                            ...
                            class="block w-full rounded-xl border-gray-300 px-4 py-3.5 text-gray-900 shadow-sm focus:border-red-600 focus:ring-red-600 sm:text-sm {{ $errors->has('password') ? 'border-red-500 ring-red-500 bg-red-50' : '' }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password_confirmation" :type="showConfirm ? 'text' : 'password'"
                            ...
                            class="block w-full rounded-xl border-gray-300 px-4 py-3.5 text-gray-900 shadow-sm focus:border-red-600 focus:ring-red-600 sm:text-sm {{ $errors->has('password_confirmation') ? 'border-red-500 ring-red-500 bg-red-50' : '' }}">
