                                            ...
                                            <td class="py-5 text-center">
                                                ...
                                                @elseif ($booking->status == 'unpaid')
                                                    <a href="{{ route('booking.payment', $booking->id) }}"
                                                        class="bg-red-600 hover:bg-red-700 text-white font-bold text-xs px-5 py-2.5 rounded-full transition shadow-sm inline-block transform hover:-translate-y-0.5">
                                                        Bayar DP
                                                    </a>
                                                @elseif($booking->status == 'paid' && $booking->remaining_balance > 0)
                                                    <span
                                                        class="text-gray-500 text-xs font-medium text-center leading-tight block">Silakan
